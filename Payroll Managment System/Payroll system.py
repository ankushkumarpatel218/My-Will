    ...
    def new_Emp():  # Function to add new employee after admin password function
        ...
        def confirm_New():  # Function to double-check info above with user if it is correct
            ...
            if employee_Confirm == "y":
                with open("employee_personal/employee_record.csv",
                          mode="a+") as add_Personal:  # Opens personal .csv and assigns to variable
                ...
                with open("employee_financial/financial_record.csv",
                          mode="a+") as add_Financial:  # Opens financial .csv and assigns to variable
